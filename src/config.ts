...
export const siteConfig: SiteConfig = {
  ...
  banner: {
    enable: true,
    src: 'assets/images/banner-new.jpg',   // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const profileConfig: ProfileConfig = {
  ...
  name: 'Dean Hiran',
  bio: 'peripheral and pc enthusiast',
  links: [
    {
      name: 'Mastodon',
      ...
      url: 'https://mastodon.social/@dandepan303',
    },
    {
      name: 'GitHub',
